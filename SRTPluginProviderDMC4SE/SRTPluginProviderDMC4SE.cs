...
{
    public class SRTPluginProviderDMC4SE : IPluginProvider
    {
        private Process process;
        private GameMemoryDMC4SEScanner gameMemoryScanner;
        ...
        public int Startup(IPluginHostDelegates hostDelegates)
        {
            ...
            process = GetProcess();
            gameMemoryScanner = new GameMemoryDMC4SEScanner(process);
